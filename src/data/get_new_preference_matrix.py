...
goods_ = goods.loc[goods.status == 'Не Архив'][['brand','Группа категорий']].drop_duplicates()
...
triple.loc[:,'sum'] = (triple.heat_count + 10*triple.cart_counter + 5*triple.wishlist_counter).astype('int16')
